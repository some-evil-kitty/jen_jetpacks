...
[
    ...
    ["KJW's Jetpacks","Jetpack"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
...
[
    QVAR(disableAlarm), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
